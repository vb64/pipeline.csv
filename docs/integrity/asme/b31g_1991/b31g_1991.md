...
Source: `asme.b31g.1991.pdf` at [YandexDisk](https://disk.yandex.ru/d/zrAzrZ7kFC2N0g)
...
![FIG.1-1 PARABOLIC CRITERIA FOR CLASSIFYING CORROSION DEFECTS ACCORDING TO PREDICTED FAILURE STRESS](/docs/img/asme1991.png)
...
![FIG.1-2 PROCEDURE FOR ANALYSIS OF CORRODED PIPE STRENGTH](/docs/img/fig_1_2.png)
...
![% pit depth = 100 * d / t](/docs/img/frml_2_1.png)
...
![L = 1.12 * B sqrt(D * t)](/docs/img/frml_2_2.png)
...
![B = sqrt( ((d / t) / (1.1 * (d / t) - 0.15))^2 - 1 ) ](/docs/img/frml_2_3.png)

except that B may not exceed the value 4.
If the corrosion depth is between 10% and 17.5%, use B = 4.0 in Eq.(2).

![FIG.2-1 CORROSION PARAMETERS USED IN ANALYSIS](/docs/img/fig_2_1.png)

_FIG.2-1 CORROSION PARAMETERS USED IN ANALYSIS_

![FIG.2-2 CURVE FOR DETERMINING THE VALUE B](/docs/img/fig_2_2.png)
...
![FIG.4-1 CURVE FOR OBTAINING Ps AS A FUNCTION OF d/t FOR VALUES OF A LESS THAN OR EOUAl TO 4.0](/docs/img/fig_4_1.png)

_FIG.4-1 CURVE FOR OBTAINING Ps AS A FUNCTION OF d/t FOR VALUES OF A LESS THAN OR EOUAl TO 4.0_

![FIG.4-2 Ps AS A FUNCTION OF d/t FOR VALUES Of A GREATER THAN 4.0](/docs/img/fig_4_2.png)
