...
from ... import ErrorIntegrity
from . import Context as ContextBase, EXPL_ROUND


class ErrMaterialSMTSNotDefined(ErrorIntegrity):
...
class Context(ContextBase):
    ...
    def z_param(self):
        ...
        z_val = pow(self.anomaly.length, 2) / (pipe.diameter * pipe.thick_mm)
        ...
        self.add_explain([
          ...
          '\n', "Z = {}^2 / ({} * {}) = {}.".format(
            ...
            round(pipe.thick_mm, EXPL_ROUND),
    ...
    def get_press_fail(self, is_mod=False):
        ...
        pipe = self.anomaly.pipe
        p_f = 2 * s_f * pipe.thick_mm / pipe.diameter
